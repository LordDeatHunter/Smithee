...
public class DisassemblyTable extends BlockWithEntity {
    ...
    public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
        return new SimpleNamedScreenHandlerFactory((i, playerInventory, playerEntity) -> new DisassemblyTableScreenHandler(i, playerInventory, (DisassemblyTableEntity)world.getBlockEntity(pos)), TITLE);
    }

    @Override
    public BlockEntity createBlockEntity(BlockView world) {
        return new DisassemblyTableEntity();
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (entity instanceof DisassemblyTableEntity) {
                ItemScatterer.spawn(world, pos, (DisassemblyTableEntity)entity);
