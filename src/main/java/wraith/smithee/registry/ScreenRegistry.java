...
import wraith.smithee.screens.ChiselingTableScreen;
...
public class ScreenRegistry {
    ...
    public static void registerScreens() {
        ...
        net.fabricmc.fabric.api.client.screenhandler.v1.ScreenRegistry.register(ScreenHandlerRegistry.SCREEN_HANDLERS.get("chiseling_table"), ChiselingTableScreen::new);
    }
